...
# Phase 1
npx snarkjs powersoftau new bn128 14 build/${base_name}/pot14_0000.ptau -v
npx snarkjs powersoftau contribute build/${base_name}/pot14_0000.ptau build/${base_name}/pot14_0001.ptau --name="First contribution" -v -e="random ooooo"
npx snarkjs powersoftau beacon build/${base_name}/pot14_0001.ptau build/${base_name}/pot14_beacon.ptau a2e7539880207acd44bc83b24887aaf95197eab45d5568af477cb9775bdaa560 10 -n="Final Beacon"
npx snarkjs powersoftau prepare phase2 build/${base_name}/pot14_beacon.ptau build/${base_name}/pot14_final.ptau -v
npx snarkjs powersoftau verify build/${base_name}/pot14_final.ptau

# Phase 2
npx snarkjs groth16 setup build/${base_name}/${base_name}.r1cs build/${base_name}/pot14_final.ptau circuit_0000.zkey
...
npx snarkjs groth16 setup build/${base_name}/${base_name}.r1cs build/${base_name}/pot14_final.ptau build/${base_name}/circuit_0000.zkey
...
l Beacon phase2"
npx snarkjs zkey verify build/${base_name}/${base_name}.r1cs build/${base_name}/pot14_final.ptau build/${base_name}/circuit_final.zkey
